...
| Forensic Investigator (Sysinternals) | mytools `ForensicInvestigator` **v3.1.2** — plus Zone.ID, PS history, Amcache/SYSTEM, browser History copies, admins/RMM, Defender, hashed manifest |
