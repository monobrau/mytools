...
| Dell SupportAssist | `DellSupportAssist` | Updates an installed copy via Dell's bootstrapper. Does not install when absent. Skips OS Recovery, Remediation, and TechHub |
